    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AllowAnyHeader()));
            ...
            services.AddTransient<IServiceMakeMoney, ServiceMakeMoney>();
            services.AddTransient<ISeviceSpend, ServiceSpend>();
            services.AddTransient<IServiceUser, ServiceUser>();
            services.AddTransient<IServiceRegisters, ServiceRegisters>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger samo", Version = "v1" });
